...
public class Text extends Effect {
	...
	//Define Colors
	static final int OFF = Frame.NEO_OFF;
	static final int RED = Frame.NEO_RED;
	static final int GRN = Frame.NEO_GREEN;
	static final int BLU = Frame.NEO_BLUE;
	static final int YEL = Frame.NEO_YELLOW;
	static final int TUR = Frame.NEO_TURK;
	static final int PUR = Frame.NEO_PINK;
	static final int WHT = Frame.NEO_WHITE;
